...
%matlab data
matlab_fname = '../../wavi_matlab_mismip_plus_results/Ice2r_CWI_WAVI_pgoff_L1L2c_Weertman_2km.nc';
%ncdisp(matlab_fname)
...
title('ice2r_pgoff_2km matlab grounding line', 'interpreter', 'none');
xlabel('x');
ylabel('y');
c = colorbar;
...
title('ice2r_pgoff_2km matlab centre line position', 'interpreter', 'none');


%
%repeat for julia
%
julia_fname = "/data/icesheet_output/aleey/wavi/MISMIP_020/run/outfile.nc"; 
